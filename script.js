...
const projectData = {
  ...
  'paint-blasters': {
    ...
    images: ['Images/PaintBlasters1.jpg', 'Images/PaintBlasters2.jpg'],
  ...
  'strange-nights': {
    ...
    images: ['Images/StrangeNights1.jpg', 'Images/StrangeNights2.jpg'],
...
const projectTranslations = {
  ...
  'paint-blasters': {
    title: 'Paint Blasters',
    text: 'Status: In ontwikkeling\nGenre: Actie-arcade shooter\nFocus: Combat, beweging en arena-gameplay\nHuidig doel: Een leuke en krachtige prototype bouwen met bevredigende shooting en vijandgesprekken.\nTeam setup: Groepsproject\nSchool assignment: Ja\nVoor: Trouw\n\nWaar ik aan werk: Ik ontwerp het gevoel van het spel, inclusief wapens, vijandgedrag en snelle combatloops.\nWat ik wil verbeteren: Ik wil het gevoel van het spel verfijnen, meer vijandvariatie toevoegen en de leveldesign en pacing verbeteren.\nHoe ik werk: Ik prototypeer systemen vroeg, test ze in gameplay en verfijn daarna het gevoel op basis van wat het leukste en duidelijkste voelt.\nConclusie: Dit project helpt me mijn combatdesign en game feel te verbeteren.',
  },
  'little-mage': {
    title: 'Little Mage',
    text: 'Status: In ontwikkeling\nGenre: Actie / avontuur\nFocus: Toverspreuken en verkenning\nHuidig doel: Een charmante magische prototype maken met beweging, magie en interacties in een kleine wereld.\nTeam setup: Solo project\nSchool assignment: Ja\nVoor: Programmerenles\n\nWaar ik aan werk: Ik bouw aan de spelerabilities, tovereffecten en de verkenningsloop om het spel magisch en responsief te laten voelen.\nWat ik wil verbeteren: Ik wil de visuele leesbaarheid van het magiesysteem verbeteren en elke spreuk onderscheidend en bevredigend laten aanvoelen.\nHoe ik werk: Ik prototypeer één kernmechaniek tegelijk en zorg dat de speler het meteen begrijpt en leuk vindt.\nConclusie: Dit project richt zich op een leuke magische fantasystijl terwijl ik leer om systemen en leesbaarheid in balans te houden.',
  },
  'strange-nights': {
    title: 'Strange Nights at Jesse Jester\'s',
    text: 'Status: Actief project\nGenre: Narratief / atmosferisch / spooky\nFocus: Verhaal, sfeer en interactie\nHuidig doel: Een eerie wereld bouwen met een opvallende stemming en sterke atmosfeer.\nTeam setup: Solo project\nSchool assignment: Nee\nVoor: Persoonlijk project\n\nWaar ik aan werk: Ik vorm de wereld, aanwezigheid van personages en sfeer zodat het spel spannend en memorabel voelt.\nWat ik wil verbeteren: Ik wil de atmosfeer meer meeslepend maken door middel van verlichting, geluid, pacing en interactieve verhaalmomenten.\nHoe ik werk: Ik bouw eerst de setting op en voeg daarna systemen en ontmoetingen toe die de toon en het verhaal ondersteunen.\nConclusie: Dit project helpt me narratief game design te onderzoeken en te ontdekken hoe ik een wereld onheilspellend en levendig kan laten voelen.',
  },
  'tb-d': {
    title: 'Neurophase - testing grounds',
    text: 'Status: Gepland\nGenre: Toekomstig project\nFocus: Nieuwe ideeën en experimenten\nHuidig doel: Deze plek open houden voor een nieuw concept dat ik kan verkennen wanneer het juiste idee ontstaat.\nTeam setup: Solo project\nSchool assignment: Nee\nVoor: Persoonlijk project\n\nWaar ik aan werk: Ik verzamel inspiratie en test ideeën voor de volgende mechanic, een thema of gameplay-loop.\nWat ik wil verbeteren: Ik wil deze ruimte gebruiken om nieuwe concepten uit te proberen en mijn creatieve richting steeds verder te ontwikkelen.\nHoe ik werk: Ik onderzoek ideeën snel, beoordeel wat uniek voelt en bouw alleen verder als het concept veel potentie heeft.\nConclusie: Dit project is bewust open eindig zodat ik door kan blijven experimenteren en het volgende idee met meer duidelijkheid kan ontwikkelen.',
  }
};
